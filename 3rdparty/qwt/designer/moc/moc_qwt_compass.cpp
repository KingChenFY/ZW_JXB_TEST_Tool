...
#include <memory>
#include "../../../qwt-git/src/qwt_compass.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QwtCompass_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QwtCompass_t qt_meta_stringdata_QwtCompass = {
    {
        QT_MOC_LITERAL(0, 10)   // "QwtCompass"
    },
    "QwtCompass"
};
...
const QMetaObject QwtCompass::staticMetaObject = { {
    ...
    qt_meta_stringdata_QwtCompass.offsetsAndSizes,
    qt_meta_data_QwtCompass,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QwtCompass_t
