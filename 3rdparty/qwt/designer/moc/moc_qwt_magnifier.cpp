...
#include <memory>
#include "../../../qwt-git/src/qwt_magnifier.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QwtMagnifier_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QwtMagnifier_t qt_meta_stringdata_QwtMagnifier = {
    {
        QT_MOC_LITERAL(0, 12)   // "QwtMagnifier"
    },
    "QwtMagnifier"
};
...
const QMetaObject QwtMagnifier::staticMetaObject = { {
    ...
    qt_meta_stringdata_QwtMagnifier.offsetsAndSizes,
    qt_meta_data_QwtMagnifier,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QwtMagnifier_t
