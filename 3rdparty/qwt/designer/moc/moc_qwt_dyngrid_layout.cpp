...
#include <memory>
#include "../../../qwt-git/src/qwt_dyngrid_layout.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QwtDynGridLayout_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QwtDynGridLayout_t qt_meta_stringdata_QwtDynGridLayout = {
    {
        QT_MOC_LITERAL(0, 16)   // "QwtDynGridLayout"
    },
    "QwtDynGridLayout"
};
...
const QMetaObject QwtDynGridLayout::staticMetaObject = { {
    ...
    qt_meta_stringdata_QwtDynGridLayout.offsetsAndSizes,
    qt_meta_data_QwtDynGridLayout,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QwtDynGridLayout_t
