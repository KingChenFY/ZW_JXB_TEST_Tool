...
#include <memory>
#include "../../../../qwt-git/examples/polardemo/Plot.h"
...
static const qt_meta_stringdata_Plot_t qt_meta_stringdata_Plot = {
    {
        ...
        QT_MOC_LITERAL(5, 13),  // "applySettings"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 12)   // "PlotSettings"
    },
    "Plot",
    "applySettings",
    "",
...
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const PlotSettings &, std::false_type>
