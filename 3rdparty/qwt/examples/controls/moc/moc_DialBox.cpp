...
#include <memory>
#include "../../../../qwt-git/examples/controls/DialBox.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DialBox_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_DialBox_t qt_meta_stringdata_DialBox = {
    {
        QT_MOC_LITERAL(0, 7),  // "DialBox"
        QT_MOC_LITERAL(8, 6),  // "setNum"
        QT_MOC_LITERAL(15, 0),  // ""
        QT_MOC_LITERAL(16, 1)   // "v"
    },
    "DialBox",
    "setNum",
    "",
...
const QMetaObject DialBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_DialBox.offsetsAndSizes,
    qt_meta_data_DialBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DialBox_t
, QtPrivate::TypeAndForceComplete<DialBox, std::true_type>
