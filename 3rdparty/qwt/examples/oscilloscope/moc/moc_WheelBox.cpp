...
#include <memory>
#include "../../../../qwt-git/examples/oscilloscope/WheelBox.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WheelBox_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_WheelBox_t qt_meta_stringdata_WheelBox = {
    {
        QT_MOC_LITERAL(0, 8),  // "WheelBox"
        QT_MOC_LITERAL(9, 12),  // "valueChanged"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 5)   // "theme"
    },
    "WheelBox",
    "valueChanged",
    "",
...
void WheelBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &WheelBox::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WheelBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_WheelBox.offsetsAndSizes,
    qt_meta_data_WheelBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_WheelBox_t
, QtPrivate::TypeAndForceComplete<QColor, std::true_type>, QtPrivate::TypeAndForceComplete<WheelBox, std::true_type>, QtPrivate::TypeAndForceComplete<double, std::false_type>, QtPrivate::TypeAndForceComplete<double, std::false_type>
