...
#include <memory>
#include "../../../../qwt-git/playground/timescale/Plot.h"
...
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const Settings &, std::false_type>
